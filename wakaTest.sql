...
*/
/*Test data*/
insert into query_customer values(null, "张健明", "13730644652", "东公元", "男", "1982-09-13");
insert into query_customer values(null, "陈超", "13730644651", "万科海悦汇城", "男", "1983-10-01");
insert into query_membership values(null, "2016-01-01", 100.00, "Helloworld", (select id from query_customer where phone="13730644651"));
insert into query_product values(null, "Prod1", 30, 7.50, "Prod1 Descriptions.");
insert into query_product values(null, "Prod2", 20, 25.0, "Prod2 Descriptions."); 
insert into query_purchasing values(null, (select id from query_product where name="Prod1"), (select id from query_membership where passphrase="Helloworld"), 2, 15.00, null);

insert into query_expenditure values(null, "2016-01-01", 1000.00, "房租", null);
